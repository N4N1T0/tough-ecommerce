...
function Hero() {
  return (
    <section className='relative w-fit h-fit'>
      ...
      <Link href='/boxing/elite-shoes-2' className='bg-black absolute py-2 px-5 text-white font-bold md:right-20 bottom-10 right-1/2 translate-x-1/2 md:translate-x-0 text-xl hover:translate-y-1 transition-transform duration-200'>
