...
export default async function CollectionPage({ params }: { params: { subCategories: string } }) {
  ...
  return (
    <ProductsLayout subCategory={params.subCategories.toLowerCase()} category='boxing'>
      <section>
        <div className='flex justify-between items-center'>
          ...
          <CategoriesMobileSheet category='collection' subCategory={params.subCategories.toLowerCase()} />
        </div>
