    ...
    <main>
      {slide === 0 &&
        <section className='relative'>
          ...
          <div className='absolute top-1/2 left-1/2 text-white -translate-x-1/2 -translate-y-1/2 text-center space-y-5'>
            <h1 className='text-9xl font-extrabold'>GLOVE FINDER</h1>
            <h2 className='text-2xl leading-8'>Don’t know where to start? Overwhelmed with options? We got you. Answer a few questions and we’ll get you to the perfect glove.</h2>
      ...
      {slide === 1 &&
        <section className='w-full flex pt-40 px-10 gap-10' id='sport'>
          <div className='flex-1 text-5xl font-bold'>
            1. WHICH SPORT ARE YOUR GLOVES FOR?
          </div>
          <div className='flex-1 text-9xl font-bold [&>button]:block py-10 space-y-10'>
      ...
      {slide === 2 &&
        <section className='w-full flex pt-40 px-10 gap-10' id='type' >
          <div className='flex-1 text-5xl font-bold'>
      ...
      {slide === 3 &&
        <section className='w-full flex pt-40 px-10 gap-10' id='price' >
          <div className='flex-1 text-5xl font-bold'>
            2. PRICE RANGE OF THE GLOVES?
          </div>
          <div className='flex-1 text-9xl font-bold [&>a]:block py-10 space-y-10'>
