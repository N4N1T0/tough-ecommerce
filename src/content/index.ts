import { Arnold, Claressa, Dustin, Jared, Johnny, Liam, Natasha, Nico, Ramla } from '@/assets'
...
export const accountLinks = [
  {
    label: 'My Account',
    link: '/account/costumer',
    internalLinks: [
      {
        label: 'Account Information',
        link: '/account/costumer/edit'
      },
      {
        label: 'Address Book',
        link: '/account/costumer/address'
      },
       {
        label: 'email Sign Up',
        link: '/account/costumer/email'
      }
    ]
  },
  {
